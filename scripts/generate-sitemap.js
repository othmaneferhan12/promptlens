...
const STATIC_PAGES = [
  ...
  { path: '/zh/blog/ai-yishu-fengge-cihui/',                      changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/zhaopian-shengcheng-ai-tishi-ci/',            changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/zuijia-tupian-zhuan-tishi-ci-gongju-2026/',   changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/tupian-zhuanhuan-ai-tishi-ci/',               changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/dall-e-3-tishi-ci-zhinan/',                   changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/flux-ai-tishi-ci-zhinan/',                    changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/ai-tishi-ci-rumen-jiaocheng/',                changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/ideogram-tishi-ci-zhinan/',                   changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/tupian-zhuan-tishi-ci-api/',                  changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/tupian-zhuan-tishi-ci-dongman/',              changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/tupian-zhuan-tishi-ci-youxi-meishu/',         changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/tupian-zhuan-tishi-ci-shinei-sheji/',         changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/tupian-zhuan-tishi-ci-shejiao-meiti/',        changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/tupian-zhuan-tishi-ci-logo-sheji/',           changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/tupian-zhuan-tishi-ci-chanpin-sheying/',      changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/leonardo-ai-tishi-ci-zhinan/',                changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/midjourney-tishi-ci-zhinan-2026/',            changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/midjourney-vs-flux/',                         changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/stable-diffusion-fumian-tishi-ci/',           changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/tishi-ci-gongcheng-ai-yishu/',               changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/tishi-ci-gongcheng-changjian-cuowu/',        changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/ai-yishu-tishi-ci-nixiang-gongcheng/',       changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/stable-diffusion-tishi-ci-zhinan/',           changefreq: 'monthly', priority: '0.7' },
  { path: '/zh/blog/stable-diffusion-vs-midjourney-vs-dalle3/',   changefreq: 'monthly', priority: '0.7' },
  ...
  { path: '/pt/blog/glossario-estilos-arte-ia/',                   changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/prompt-ia-a-partir-de-foto/',                  changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/melhores-ferramentas-imagem-para-prompt-2026/', changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/converter-imagem-em-prompt-ia/',               changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/guia-prompts-dall-e-3/',                       changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/guia-prompts-flux-ai/',                        changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/como-escrever-prompts-ia-iniciantes/',         changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/guia-prompts-ideogram/',                       changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/imagem-para-prompt-api/',                      changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/imagem-para-prompt-anime/',                    changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/imagem-para-prompt-game-art/',                 changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/imagem-para-prompt-design-interiores/',        changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/imagem-para-prompt-redes-sociais/',            changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/imagem-para-prompt-design-logo/',              changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/imagem-para-prompt-fotografia-produto/',       changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/guia-prompts-leonardo-ai/',                    changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/guia-prompts-midjourney-2026/',                changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/midjourney-vs-flux/',                          changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/prompts-negativos-stable-diffusion/',          changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/engenharia-de-prompts-arte-ia/',               changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/erros-engenharia-de-prompts/',                 changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/engenharia-reversa-prompts-ia/',               changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/guia-prompts-stable-diffusion/',               changefreq: 'monthly', priority: '0.7' },
  { path: '/pt/blog/stable-diffusion-vs-midjourney-vs-dalle3/',    changefreq: 'monthly', priority: '0.7' },
  ...
  { path: '/de/blog/ai-kunststile-glossar/',                       changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/ai-prompt-aus-foto/',                          changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/beste-bild-zu-prompt-tools-2026/',             changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/bild-in-ai-prompt-umwandeln/',                 changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/dall-e-3-prompt-leitfaden/',                   changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/flux-ai-prompt-leitfaden/',                    changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/ai-prompts-schreiben-anfaenger/',              changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/ideogram-prompt-leitfaden/',                   changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/bild-zu-prompt-api/',                          changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/bild-zu-prompt-anime/',                        changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/bild-zu-prompt-game-art/',                     changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/bild-zu-prompt-inneneinrichtung/',             changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/bild-zu-prompt-social-media/',                 changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/bild-zu-prompt-logo-design/',                  changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/bild-zu-prompt-produktfotografie/',            changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/leonardo-ai-prompt-leitfaden/',                changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/midjourney-prompt-leitfaden-2026/',            changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/midjourney-vs-flux/',                          changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/negative-prompts-stable-diffusion/',           changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/prompt-engineering-ai-kunst/',                 changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/prompt-engineering-fehler/',                   changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/reverse-engineering-ai-prompts/',              changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/stable-diffusion-prompt-leitfaden/',           changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/stable-diffusion-vs-midjourney-vs-dalle3/',    changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/text-zu-prompt-generator/',                    changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/veo-vs-kling-vs-runway/',                      changefreq: 'monthly', priority: '0.7' },
  { path: '/de/blog/video-ai-prompt-leitfaden-2026/',              changefreq: 'monthly', priority: '0.7' },
];
