  ...
  return (
    <div className="relative">
      <div className="flex flex-col gap-1.5">
        <p className="font-inter text-xs font-600 uppercase tracking-widest text-[var(--text-secondary)]">
          Daily analyses
        </p>
        <button
        ...
        >
          ...
          <span
            className="font-inter text-xs font-600 uppercase tracking-widest"
